...
export class AdbScrcpyOptions3_3<
    TInit extends ScrcpyOptions3_3.Init = ScrcpyOptions3_3.Init,
>
    extends ScrcpyOptions3_3<TInit>
    implements
        AdbScrcpyOptions<ScrcpyOptions3_3.Value<TInit>>,
...
export namespace AdbScrcpyOptions3_3 {
    export type Init = ScrcpyOptions3_3.Init;
}
