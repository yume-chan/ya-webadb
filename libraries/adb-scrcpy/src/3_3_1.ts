...
export class AdbScrcpyOptions3_3_1<
    TInit extends ScrcpyOptions3_3_1.Init = ScrcpyOptions3_3_1.Init,
>
    extends ScrcpyOptions3_3_1<TInit>
    implements
        AdbScrcpyOptions<ScrcpyOptions3_3_1.Value<TInit>>,
...
export namespace AdbScrcpyOptions3_3_1 {
    export type Init = ScrcpyOptions3_3_1.Init;
}
