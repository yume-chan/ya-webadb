...
export class AdbScrcpyOptions4_1<
    TInit extends ScrcpyOptions4_1.Init = ScrcpyOptions4_1.Init,
>
    extends ScrcpyOptions4_1<TInit>
    implements
        AdbScrcpyOptions<ScrcpyOptions4_1.Value<TInit>>,
...
export namespace AdbScrcpyOptions4_1 {
    export type Init = ScrcpyOptions4_1.Init;
}
