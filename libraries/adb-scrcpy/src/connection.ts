...
export class AdbScrcpyForwardConnection extends AdbScrcpyConnection {
  ...
  #connect(): Promise<ReadableWritablePair<Uint8Array, Consumable<Uint8Array>>> {
    return this.adb.createSocket(this.socketName);
  }

  async #connectAndRetry(sendDummyByte: boolean): Promise<ReadableWritablePair<Uint8Array, Consumable<Uint8Array>>> {
...
export class AdbScrcpyReverseConnection extends AdbScrcpyConnection {
  #streams!: ReadableStreamDefaultReader<ReadableWritablePair<Uint8Array, Consumable<Uint8Array>>>;
  ...
  async #accept(): Promise<ReadableWritablePair<Uint8Array, Consumable<Uint8Array>>> {
