...
import type { ScrcpyDisplay, ScrcpyEncoder, ScrcpyOptions1_22Impl } from '@yume-chan/scrcpy';
...
export class AdbScrcpyOptions1_22 extends AdbScrcpyOptions<
  ...
  Pick<ScrcpyOptions1_22Impl.Init, 'tunnelForward' | 'control' | 'sendDummyByte'>
> {
