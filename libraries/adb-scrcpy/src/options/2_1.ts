...
import type { ScrcpyDisplay, ScrcpyEncoder, ScrcpyOptions2_1Impl } from '@yume-chan/scrcpy';
...
export class AdbScrcpyOptions2_1 extends AdbScrcpyOptions<
  ...
  Pick<ScrcpyOptions2_1Impl.Init, 'tunnelForward' | 'control' | 'sendDummyByte' | 'scid' | 'audio' | 'video'>
> {
