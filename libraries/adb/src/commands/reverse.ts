...
import { encodeUtf8, ExactReadableEndedError, string, struct } from '@yume-chan/struct';
...
const AdbReverseErrorResponse = struct(/* #__PURE__ */ (() => AdbReverseStringResponse.fields)(), {
  littleEndian: true,
...
export class AdbReverseCommand {
   ...
   */
  async add(deviceAddress: string, handler: AdbIncomingSocketHandler, localAddress?: string): Promise<string> {
