...
describe('adbGeneratePublicKey', () => {
  it('should return correct value', () => {
    ...
    assert.deepStrictEqual(generated.subarray(0, 4), PUBLIC_KEY.subarray(0, 4));
    assert.deepStrictEqual(generated.subarray(4, 8), PUBLIC_KEY.subarray(4, 8));
    assert.deepStrictEqual(generated.subarray(8, 264), PUBLIC_KEY.subarray(8, 264));
    assert.deepStrictEqual(generated.subarray(265, 520), PUBLIC_KEY.subarray(265, 520));
    assert.deepStrictEqual(generated.subarray(520, 524), PUBLIC_KEY.subarray(520, 524));
  });

  it('should throw if output is too small', () => {
    assert.throws(() => adbGeneratePublicKey(PRIVATE_KEY, new Uint8Array(1)), /output buffer is too small/);
  });
});
