 ...
 */
export function getBigUint(array: Uint8Array, byteOffset: number, length: number): bigint {
  let result = 0n;
...
export function adbGeneratePublicKey(privateKey: Uint8Array, output: Uint8Array): number;
export function adbGeneratePublicKey(privateKey: Uint8Array, output?: Uint8Array): Uint8Array | number {
