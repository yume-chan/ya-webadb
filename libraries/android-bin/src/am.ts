...
const START_ACTIVITY_OPTIONS_MAP: Partial<Record<keyof ActivityManagerStartActivityOptions, string>> = {
  displayId: '--display',
...
export class ActivityManager extends AdbCommandBase {
  ...
  async startActivity(options: ActivityManagerStartActivityOptions): Promise<void> {
