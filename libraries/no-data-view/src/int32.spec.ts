...
describe('getInt32', () => {
  describe('little endian', () => {
    it('should work for minimal value', () => {
      ...
      assert.strictEqual(getInt32LittleEndian(array, 0), new DataView(array.buffer).getInt32(0, true));
    });
  ...
  describe('big endian', () => {
    it('should work for minimal value', () => {
      ...
      assert.strictEqual(getInt32BigEndian(array, 0), new DataView(array.buffer).getInt32(0, false));
    });
  ...
  it('should work for selected endianness', () => {
    const array = new Uint8Array([1, 2, 3, 4]);
    assert.strictEqual(getInt32(array, 0, false), new DataView(array.buffer).getInt32(0, false));
    assert.strictEqual(getInt32(array, 0, true), new DataView(array.buffer).getInt32(0, true));
  });
});
