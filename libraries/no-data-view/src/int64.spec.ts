...
describe('getInt64', () => {
  describe('little endian', () => {
    it('should work for minimal value', () => {
      ...
      assert.strictEqual(getInt64LittleEndian(array, 0), new DataView(array.buffer).getBigInt64(0, true));
    });

    it('should work for maximal value', () => {
      const array = new Uint8Array([0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x7f]);
      assert.strictEqual(getInt64LittleEndian(array, 0), new DataView(array.buffer).getBigInt64(0, true));
    });
    ...
    it('should work for random value', () => {
      const array = new Uint8Array([0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08]);
      assert.strictEqual(getInt64LittleEndian(array, 0), new DataView(array.buffer).getBigInt64(0, true));
    });
  });
  ...
  describe('big endian', () => {
    it('should work for minimal value', () => {
      ...
      assert.strictEqual(getInt64BigEndian(array, 0), new DataView(array.buffer).getBigInt64(0, false));
    });

    it('should work for maximal value', () => {
      const array = new Uint8Array([0x7f, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff]);
      assert.strictEqual(getInt64BigEndian(array, 0), new DataView(array.buffer).getBigInt64(0, false));
    });
  ...
  it('should work for selected endianness', () => {
    ...
    assert.strictEqual(getInt64(array, 0, false), new DataView(array.buffer).getBigInt64(0, false));
    assert.strictEqual(getInt64(array, 0, true), new DataView(array.buffer).getBigInt64(0, true));
  });
});
...
describe('setInt64', () => {
  describe('little endian', () => {
    it('should work for minimal value', () => {
      ...
      new DataView(expected.buffer).setBigInt64(0, -0x8000_0000_0000_0000n, true);
    ...
    it('should work for maximal value', () => {
      const expected = new Uint8Array(8);
      new DataView(expected.buffer).setBigInt64(0, 0x7fff_ffff_ffff_ffffn, true);
      const actual = new Uint8Array(8);
    ...
    it('should work for middle value', () => {
      const expected = new Uint8Array(8);
      new DataView(expected.buffer).setBigInt64(0, 0xedcb_a987_6543_2100n, true);
      const actual = new Uint8Array(8);
  ...
  describe('big endian', () => {
    it('should work for minimal value', () => {
      const expected = new Uint8Array(8);
      new DataView(expected.buffer).setBigInt64(0, -0x8000_0000_0000_0000n, false);
      const actual = new Uint8Array(8);
    ...
    it('should work for maximal value', () => {
      const expected = new Uint8Array(8);
      new DataView(expected.buffer).setBigInt64(0, 0x7fff_ffff_ffff_ffffn, false);
      const actual = new Uint8Array(8);
    ...
    it('should work for middle value', () => {
      const expected = new Uint8Array(8);
      new DataView(expected.buffer).setBigInt64(0, 0xedcb_a987_6543_2100n, false);
      const actual = new Uint8Array(8);
