...
describe('getUint16', () => {
  describe('little endian', () => {
    it('should work for minimal value', () => {
      ...
      assert.strictEqual(getUint16LittleEndian(array, 0), new DataView(array.buffer).getUint16(0, true));
    });
  ...
  describe('big endian', () => {
    it('should work for minimal value', () => {
      const array = new Uint8Array([0, 0]);
      assert.strictEqual(getUint16BigEndian(array, 0), new DataView(array.buffer).getUint16(0, false));
    });
  ...
  it('should work for selected endianness', () => {
    const array = new Uint8Array([1, 2]);
    assert.strictEqual(getUint16(array, 0, false), new DataView(array.buffer).getUint16(0, false));
    assert.strictEqual(getUint16(array, 0, true), new DataView(array.buffer).getUint16(0, true));
  });
});
