...
describe('getUint32', () => {
  describe('little endian', () => {
    it('should work for minimal value', () => {
      ...
      assert.strictEqual(getUint32LittleEndian(array, 0), new DataView(array.buffer).getUint32(0, true));
    });
  ...
  describe('big endian', () => {
    it('should work for minimal value', () => {
      const array = new Uint8Array([0, 0, 0, 0]);
      assert.strictEqual(getUint32BigEndian(array, 0), new DataView(array.buffer).getUint32(0, false));
    });
  ...
  it('should work for selected endianness', () => {
    const array = new Uint8Array([1, 2, 3, 4]);
    assert.strictEqual(getUint32(array, 0, false), new DataView(array.buffer).getUint32(0, false));
    assert.strictEqual(getUint32(array, 0, true), new DataView(array.buffer).getUint32(0, true));
  });
});
