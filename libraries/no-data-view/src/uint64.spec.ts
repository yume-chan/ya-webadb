...
describe('getUint64', () => {
  describe('little endian', () => {
    it('should work for minimal value', () => {
      ...
      assert.strictEqual(getUint64LittleEndian(array, 0), new DataView(array.buffer).getBigUint64(0, true));
    });
  ...
  describe('big endian', () => {
    it('should work for minimal value', () => {
      const array = new Uint8Array([0, 0, 0, 0, 0, 0, 0, 0]);
      assert.strictEqual(getUint64BigEndian(array, 0), new DataView(array.buffer).getBigUint64(0, false));
    });
  ...
  it('should work for selected endianness', () => {
    ...
    assert.strictEqual(getUint64(array, 0, false), new DataView(array.buffer).getBigUint64(0, false));
    assert.strictEqual(getUint64(array, 0, true), new DataView(array.buffer).getBigUint64(0, true));
  });
});
...
describe('setUint64', () => {
  describe('little endian', () => {
    ...
    it('should work for maximal value', () => {
      const expected = new Uint8Array(8);
      new DataView(expected.buffer).setBigUint64(0, 0xffff_ffff_ffff_ffffn, true);
      const actual = new Uint8Array(8);
    ...
    it('should work for middle value', () => {
      const expected = new Uint8Array(8);
      new DataView(expected.buffer).setBigUint64(0, 0x8000_0000_0000_0000n, true);
      const actual = new Uint8Array(8);
  ...
  describe('big endian', () => {
    ...
    it('should work for maximal value', () => {
      const expected = new Uint8Array(8);
      new DataView(expected.buffer).setBigUint64(0, 0xffff_ffff_ffff_ffffn, false);
      const actual = new Uint8Array(8);
    ...
    it('should work for middle value', () => {
      const expected = new Uint8Array(8);
      new DataView(expected.buffer).setBigUint64(0, 0x8000_0000_0000_0000n, false);
      const actual = new Uint8Array(8);
