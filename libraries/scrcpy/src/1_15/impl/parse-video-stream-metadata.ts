...
import type { ScrcpyVideoStream, ScrcpyVideoStreamMetadata } from '../../base/index.js';
 ...
 */
export async function readString(stream: AsyncExactReadable, maxLength: number): Promise<string> {
...
export async function parseVideoStreamMetadata(stream: ReadableStream<Uint8Array>): Promise<ScrcpyVideoStream> {
