...
export const ControlMessageTypes = {
    ...
    [ScrcpyControlMessageType.CameraSetTorch]: 18,
    [ScrcpyControlMessageType.CameraZoomIn]: 19,
    [ScrcpyControlMessageType.CameraZoomOut]: 20,
    [ScrcpyControlMessageType.ResizeDisplay]: 21,
    [ScrcpyControlMessageType.ScanFile]: 22,
