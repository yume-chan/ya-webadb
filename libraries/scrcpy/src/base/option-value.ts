...
export function isScrcpyOptionValue(value: unknown): value is ScrcpyOptionValue {
  return (
    typeof value === 'object' && value !== null && 'toOptionValue' in value && typeof value.toOptionValue === 'function'
  );
}
