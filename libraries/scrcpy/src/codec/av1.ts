...
export class Av1 extends BitReader {
  ...
  *frameUnit(sz: bigint): Generator<Av1.OpenBitstreamUnit, void, void> {
  ...
  openBitstreamUnit(sz?: bigint) {
    ...
    let sequence_header_obu: ReturnType<Av1['sequenceHeaderObu']> | undefined;
  ...
  obuHeader() {
    ...
    let obu_extension_header: ReturnType<Av1['obuExtensionHeader']> | undefined;
  ...
  sequenceHeaderObu() {
    ...
    let operating_parameters_info: ReturnType<Av1['operatingParametersInfo']>[] | undefined;
  ...
  colorConfig(seq_profile: number) {
    ...
    let color_primaries: Av1.ColorPrimaries = Av1.ColorPrimaries.Unspecified;
    let transfer_characteristics: Av1.TransferCharacteristics = Av1.TransferCharacteristics.Unspecified;
    let matrix_coefficients: Av1.MatrixCoefficients = Av1.MatrixCoefficients.Unspecified;
...
export namespace Av1 {
  export type OpenBitstreamUnit = Exclude<ReturnType<Av1['openBitstreamUnit']>, undefined>;
