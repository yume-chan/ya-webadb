...
export function h265ParseVideoParameterSet(nalu: Uint8Array) {
  ...
  for (
    let i = vps_sub_layer_ordering_info_present_flag ? 0 : vps_max_sub_layers_minus1;
 ...
 */
export function h265ParseVuiParameters(reader: NaluSodbBitReader, sps_max_sub_layers_minus1: number) {
 ...
 */
export function h265ParseSubLayerHrdParameters(reader: NaluSodbBitReader, subLayerId: number, CpbCnt: number) {
