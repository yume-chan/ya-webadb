...
describe("Struct", () => {
    describe(".constructor", () => {
        it("should initialize fields", () => {
            ...
            assert.strictEqual(struct.options, StructDefaultOptions);
    ...
    describe("#field", () => {
        ...
        it("should push a field and update size", () => {
            ...
            assert.strictEqual(fieldDefinition1.getSize.mock.calls.length, 1);
            ...
            assert.strictEqual(fieldDefinition2.getSize.mock.calls.length, 1);
    ...
    describe("#number", () => {
        it("`int8` should append an `int8` field", () => {
            ...
            assert.strictEqual(definition.type, NumberFieldType.Int8);
        });
        ...
        it("`uint8` should append an `uint8` field", () => {
            ...
            const definition = struct.fields[0]![1] as NumberFieldDefinition;
            assert.ok(definition instanceof NumberFieldDefinition);
            assert.strictEqual(definition.type, NumberFieldType.Uint8);
        });
        ...
        it("`int16` should append an `int16` field", () => {
            ...
            const definition = struct.fields[0]![1] as NumberFieldDefinition;
            assert.ok(definition instanceof NumberFieldDefinition);
            assert.strictEqual(definition.type, NumberFieldType.Int16);
        });
        ...
        it("`uint16` should append an `uint16` field", () => {
            ...
            const definition = struct.fields[0]![1] as NumberFieldDefinition;
            assert.ok(definition instanceof NumberFieldDefinition);
            assert.strictEqual(definition.type, NumberFieldType.Uint16);
        });
        ...
        it("`int32` should append an `int32` field", () => {
            ...
            const definition = struct.fields[0]![1] as NumberFieldDefinition;
            assert.ok(definition instanceof NumberFieldDefinition);
            assert.strictEqual(definition.type, NumberFieldType.Int32);
        });
        ...
        it("`uint32` should append an `uint32` field", () => {
            ...
            const definition = struct.fields[0]![1] as NumberFieldDefinition;
            assert.ok(definition instanceof NumberFieldDefinition);
            assert.strictEqual(definition.type, NumberFieldType.Uint32);
        });
        ...
        it("`int64` should append an `int64` field", () => {
            ...
            assert.strictEqual(definition.type, BigIntFieldType.Int64);
        });
        ...
        it("`uint64` should append an `uint64` field", () => {
            ...
            const definition = struct.fields[0]![1] as BigIntFieldDefinition;
            assert.ok(definition instanceof BigIntFieldDefinition);
            assert.strictEqual(definition.type, BigIntFieldType.Uint64);
        });
        ...
        describe("#uint8ArrayLike", () => {
            describe("FixedLengthBufferLikeFieldDefinition", () => {
                it("`#uint8Array` with fixed length", () => {
                    ...
                    assert.ok(definition.type instanceof BufferFieldSubType);
        ...
        describe("#concat", () => {
            it("should append all fields from other struct", () => {
                ...
                assert.strictEqual(
                    (field0[1] as NumberFieldDefinition).type,
                ...
                assert.strictEqual(
                    (field1[1] as NumberFieldDefinition).type,
                ...
                assert.strictEqual(
                    (field2[1] as NumberFieldDefinition).type,
                    NumberFieldType.Int32,
                );

                const field3 = struct.fields[3]!;
                assert.strictEqual(field3[0], "int64");
                assert.strictEqual(
                    (field3[1] as NumberFieldDefinition).type,
        ...
        describe("#deserialize", () => {
            it("should deserialize without dynamic size fields", () => {
                ...
                assert.deepStrictEqual(result, { foo: 2, bar: 16 });
        ...
        describe("#postDeserialize", () => {
            ...
            it("can replace return value", () => {
                ...
                assert.strictEqual(callback.mock.calls.length, 1);
                assert.deepStrictEqual(callback.mock.calls[0], [{}]);
            });
            ...
            it("can return nothing", () => {
                ...
                assert.strictEqual(callback.mock.calls.length, 1);
                assert.deepStrictEqual(callback.mock.calls[0], [result]);
            });
            ...
            it("should overwrite callback", () => {
                ...
                assert.strictEqual(callback1.mock.calls.length, 0);
                assert.strictEqual(callback2.mock.calls.length, 1);
                assert.deepStrictEqual(callback2.mock.calls[0], [{}]);
            });
        });
